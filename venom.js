...
var servers = ['380414749416095745',',','','','','','','','','','','','','',''];
var queue = [];
var guilds = ['',''];
var queueNames = [];
var isPlaying = false;
...
client.user.setGame(`1Play `,'https://www.twitch.tv/mixclann')
				...
				fetchVideoInfo(id, function(err, videoInfo) {
					...
					let play_info = new Discord.RichEmbed()
						...
						.addField('||**تم تشغيل **', `**${videoInfo.title}
							  **`)
						.setColor("RANDOM")
                        .addField(`من قبل: ${message.author.username}`, `**Smoking-Max**`)
						.setThumbnail(videoInfo.thumbnailUrl)
				...
				fetchVideoInfo(id, function(err, videoInfo) {
					...
					let play_info = new Discord.RichEmbed()
						...
						.addField('||** Playing **', `**${videoInfo.title}
							  **`)
						.setColor("RANDOM")
                        .addField(`By : ${message.author.username}`, `**Smoking-Max**`)
						.setThumbnail(videoInfo.thumbnailUrl)
